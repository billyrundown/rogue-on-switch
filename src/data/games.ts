...
const seed: Omit<Game, 'slug' | 'summary' | 'bestFor' | 'skipIf' | 'progression' | 'switchNotes' | 'sourceUrl' | 'lastChecked'>[] = [
  ...
  { title: 'Rogue Legacy 2', playstyle: 'Action', genre: 'Platformer', classification: 'Roguelite', runLength: '15–35 min', price: '$24.99', coOp: 'No', difficulty: 'Medium' },
  { title: 'Have a Nice Death', playstyle: 'Action', genre: 'Action platformer', classification: 'Roguelite', runLength: '20–45 min', price: '$24.99', coOp: 'No', difficulty: 'Hard' },
  { title: 'Neon Abyss', playstyle: 'Shooter', genre: 'Platform shooter', classification: 'Roguelite', runLength: '25–45 min', price: '$19.99', coOp: 'No', difficulty: 'Medium' },
  { title: 'Skul: The Hero Slayer', playstyle: 'Action', genre: 'Action platformer', classification: 'Roguelite', runLength: '25–50 min', price: '$19.99', coOp: 'No', difficulty: 'Hard' },
  { title: 'The Binding of Isaac: Repentance', playstyle: 'Shooter', genre: 'Twin-stick shooter', classification: 'Roguelike', runLength: '25–50 min', price: '$59.99', coOp: 'Local', difficulty: 'Hard' },
  { title: 'Nuclear Throne', playstyle: 'Shooter', genre: 'Twin-stick shooter', classification: 'Roguelike', runLength: '15–30 min', price: '$11.99', coOp: 'Local', difficulty: 'Hard' },
  { title: 'Downwell', playstyle: 'Action', genre: 'Vertical shooter', classification: 'Roguelike', runLength: '10–20 min', price: '$2.99', coOp: 'No', difficulty: 'Hard' },
  { title: 'Crypt of the NecroDancer', playstyle: 'Action', genre: 'Rhythm dungeon', classification: 'Roguelike', runLength: '15–30 min', price: '$19.99', coOp: 'Local', difficulty: 'Hard' },
  { title: 'Darkest Dungeon', playstyle: 'Tactics', genre: 'Turn-based RPG', classification: 'Roguelite', runLength: '30–60 min', price: '$24.99', coOp: 'No', difficulty: 'Hard' },
  { title: 'Griftlands', playstyle: 'Cards', genre: 'Deckbuilding', classification: 'Roguelite', runLength: '45–90 min', price: '$19.99', coOp: 'No', difficulty: 'Medium' },
  { title: 'One Step From Eden', playstyle: 'Action', genre: 'Deckbuilding action', classification: 'Roguelite', runLength: '20–40 min', price: '$19.99', coOp: 'Local', difficulty: 'Hard' },
  { title: 'Breachway', playstyle: 'Cards', genre: 'Deckbuilding strategy', classification: 'Roguelite', runLength: '30–60 min', price: '$19.99', coOp: 'No', difficulty: 'Medium' },
  { title: 'Fights in Tight Spaces', playstyle: 'Tactics', genre: 'Deckbuilding tactics', classification: 'Roguelike', runLength: '25–45 min', price: '$24.99', coOp: 'No', difficulty: 'Medium' },
  { title: 'Tangledeep', playstyle: 'Tactics', genre: 'Dungeon crawler', classification: 'Roguelike', runLength: '30–60 min', price: '$19.99', coOp: 'No', difficulty: 'Medium' },
  { title: 'Flame in the Flood', playstyle: 'Tactics', genre: 'Survival', classification: 'Roguelite', runLength: '20–45 min', price: '$14.99', coOp: 'No', difficulty: 'Medium' },
  { title: 'Streets of Rogue', playstyle: 'Co-op', genre: 'Immersive sim', classification: 'Roguelite', runLength: '20–40 min', price: '$19.99', coOp: 'Local', difficulty: 'Medium' },
  { title: 'Ship of Fools', playstyle: 'Co-op', genre: 'Action', classification: 'Roguelite', runLength: '20–40 min', price: '$14.99', coOp: 'Local', difficulty: 'Medium' },
  { title: 'Ravenswatch', playstyle: 'Co-op', genre: 'Action RPG', classification: 'Roguelite', runLength: '30–60 min', price: '$24.99', coOp: 'Online', difficulty: 'Hard' },
  { title: 'Astral Ascent', playstyle: 'Action', genre: 'Action platformer', classification: 'Roguelite', runLength: '25–50 min', price: '$24.99', coOp: 'Local', difficulty: 'Medium' },
  { title: 'Warm Snow', playstyle: 'Action', genre: 'Action RPG', classification: 'Roguelite', runLength: '25–50 min', price: '$19.99', coOp: 'No', difficulty: 'Medium' },
];

export const games: Game[] = seed.map((game) => ({
  ...game,
  slug: game.title.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-$/, ''),
